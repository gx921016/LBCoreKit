...
@implementation NSString (LBCoreKit)
#pragma mark - 正则匹配
/**
 *  匹配Email#import <CommonCrypto/CommonCrypto.h>
 *
 *  @return YES 成功 NO 失败
 */
- (BOOL)isEmail {
...
- (CGSize)widthWithHeight:(CGFloat)height andFont:(CGFloat)font {
    NSDictionary *attribute = @{NSFontAttributeName: SYSTEMFONT(font)};
